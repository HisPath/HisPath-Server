...
public class ResumeController {
    ...
    public ResponseEntity<ResumeResponse> update(@RequestBody ResumeCURequest request){
        ResumeResponse response = ResumeResponse.of(resumeService.update(new ResumeDto(1L, request.getContent())));
        return ResponseEntity.ok(response);
    }
